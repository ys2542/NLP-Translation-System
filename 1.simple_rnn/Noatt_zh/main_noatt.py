...
decoder = DecoderRNN(hidden_size, lang_en_zh.n_words, n_layers, dropout=dropout).to(device)
...
while epoch < n_epochs:
    ...
    torch.save(encoder.state_dict(), "noatt_encoder_zh")
    torch.save(decoder.state_dict(), "noatt_decoder_zh")
        
out = {"train_loss_1000_step": train_loss_step, 
       "validation_loss_1000_step": val_loss_step
       }

with open('noatt_output_zh.txt', 'w') as file:
