...
#         encoder_outputs[ei] = encoder_output[0, 0]
    ...
    if use_teacher_forcing:
        for di in range(max_target_length):
            ...
            decoder_output, decoder_hidden = decoder_output.to(device), decoder_hidden.to(device)
...
def evaluate(input_batches, input_lengths, output_lang, target_batches, target_lengths, encoder, decoder, max_length=MAX_LENGTH):     encoder.train(False)
    decoder.train(False)
